    ...
    <div className='p-10'>
        ...
        <div>
            ...
            <div>
                ...
                <div className='p-4 border rounded-2xl bg-zinc-700' dangerouslySetInnerHTML={{__html:ContentInfo?.exercisesContent?.task}}/>
            </div>

            <div>
                <h2 className='font-game text-3xl mt-4 flex gap-2 items-center text-yellow-400'> <Lightbulb /> Hint</h2>
                <div className='p-4 border rounded-2xl bg-zinc-700' dangerouslySetInnerHTML={{__html:ContentInfo?.exercisesContent?.hint}}/>
            </div>
        </div>
    }
    </div>
